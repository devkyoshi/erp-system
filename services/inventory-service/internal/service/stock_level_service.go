...
func (s *StockLevelService) AdjustQuantity(ctx context.Context, productID, locationID primitive.ObjectID, delta float64, cost float64) error {
	if err := s.stockRepo.AdjustQuantity(ctx, productID, locationID, delta, cost); err != nil {
